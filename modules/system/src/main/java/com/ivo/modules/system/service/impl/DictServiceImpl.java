...
import com.ivo.modules.system.repository.DictRepository;
import com.ivo.modules.system.service.DictService;
...
public class DictServiceImpl implements DictService {
    ...
    public Dict getByNameOk(String name){
        return dictRepository.findByNameAndStatus(name, StatusEnum.VALID.getCode());
    }
