...
@Setter
@Entity
@Table(name = "COQ_ReworkAndScrap_CellProduction")
@SQLDelete(sql = "update COQ_ReworkAndScrap_CellProduction" + StatusUtil.sliceDelete)
@Where(clause = StatusUtil.notDelete)
public class CellProduction extends Model {
